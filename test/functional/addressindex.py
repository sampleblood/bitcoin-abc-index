...
class AddressIndexTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-debug", "-relaypriority=0","-deprecatedrpc=signrawtransaction"],["-debug", "-addressindex","-deprecatedrpc=signrawtransaction"],
                           ["-debug", "-addressindex", "-relaypriority=0","-deprecatedrpc=signrawtransaction"], ["-debug", "-addressindex","-deprecatedrpc=signrawtransaction"]]
